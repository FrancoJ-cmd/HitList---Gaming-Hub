package com.hitlist.news.data.steamnews

import com.hitlist.news.data.GameNewsSource
...
class SteamNewsProxy(private val client: HttpClient) : GameNewsSource {
    ...
    private fun SteamNewsItemDto.toDomain() = NewsArticle(
        title = title,
        description = contents.stripHtmlTags().unescapeHtmlEntities().take(200).ifBlank { null },
